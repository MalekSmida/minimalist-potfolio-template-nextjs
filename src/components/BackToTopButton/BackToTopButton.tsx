...
const BackToTopButton: React.FC = () => {
  ...
  return (
    <button
      ...
      className="border-primary text-primary hover:bg-primary active:bg-primary dark:border-secondary dark:text-secondary dark:hover:bg-secondary fixed right-10 bottom-10 z-50 cursor-pointer rounded-full border p-3 hover:text-white dark:hover:text-gray-900"
      title="Scroll to top"
